...
REQUESTS = Counter(
    "q2_requests_total", "Total HTTP requests", ["path", "method", "code"], registry=REGISTRY
)


@app.middleware("http")
async def _metrics_and_request_id(request: Request, call_next: Callable) -> Response:
    ...
    try:
        ...
        try:
            ...
            pass  # Metrics failures should not break requests
...
def metrics() -> PlainTextResponse | Response:
